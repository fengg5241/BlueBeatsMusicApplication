        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.ic_home:
                        Intent intent1 = new Intent(AlbumPage.this, SecondHomePage.class);
                        startActivity(intent1);
                        break;

                    case R.id.ic_discover:
                        Intent intent2 = new Intent(AlbumPage.this, DiscoverActivity.class);
                        startActivity(intent2);
                        break;

                    case R.id.ic_search:
                        Intent intent3 = new Intent(AlbumPage.this, SearchActivity.class);
                    ...
                    case R.id.ic_profile:
                        Intent intent4 = new Intent(AlbumPage.this, ProfileActivity.class);
